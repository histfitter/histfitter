...
//ClassImp(Combination::TMsgLogger)
...
Combination::TMsgLevel Combination::TMsgLogger::m_minLevel = kINFO;

Combination::TMsgLogger::TMsgLogger( const TObject* source, TMsgLevel /* minLevel */ )
   : m_objSource( source ), 
     m_strSource( "" ), 
     m_prefix( PREFIX ), 
     m_suffix( SUFFIX ), 
...
Combination::TMsgLogger::TMsgLogger( const string& source, TMsgLevel /* minLevel */ )
   : m_objSource( 0 ),
     m_strSource( source ), 
     m_prefix( PREFIX ), 
     m_suffix( SUFFIX ), 
...
Combination::TMsgLogger::TMsgLogger( TMsgLevel /* minLevel */ )
   : m_objSource( 0 ), 
     m_strSource( "Unknown" ), 
     m_prefix( PREFIX ), 
     m_suffix( SUFFIX ), 
...
Combination::TMsgLogger::TMsgLogger( const TMsgLogger& parent )
...
Combination::TMsgLogger::~TMsgLogger() 
{}

Combination::TMsgLogger& Combination::TMsgLogger::operator= ( const TMsgLogger& parent ) 
{
...
string Combination::TMsgLogger::GetFormattedSource() const
{
...
string Combination::TMsgLogger::GetPrintedSource() const
{ 
...
void Combination::TMsgLogger::Send() 
{
...
void Combination::TMsgLogger::WriteMsg( TMsgLevel mlevel, const std::string& line ) const 
{
...
Combination::TMsgLogger& Combination::TMsgLogger::endmsg( TMsgLogger& logger ) 
{
   // end line
   logger.Send();
   return logger;
...
Combination::TMsgLevel Combination::TMsgLogger::MapLevel( const TString& instr ) const
{
...
void Combination::TMsgLogger::InitMaps()
{
