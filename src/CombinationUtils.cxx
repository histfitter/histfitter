...
void 
Combination::resetFloatPars( const RooWorkspace* w, const RooFitResult* result )
{
...
float
Util::getValueFromTree( TTree* tree, const std::string& searchpar,
...
//_____________________________________________________________________________
float
Util::getValueFromTree( TTree* tree, const std::string& searchpar, const std::vector<std::string>& pnVec, const std::vector<float>& vVec )
{
  float searchval(-1);
...
bool
Util::findValueFromTree( TTree* tree, const std::string& searchpar, float& searchval,
                         const std::string& pn0, const float& v0, const std::string& pn1, const float& v1,
                         const std::string& pn2, const float& v2, const std::string& pn3, const float& v3,
                         const std::string& pn4, const float& v4, const std::string& pn5, const float& v5,
                         const std::string& pn6, const float& v6, const std::string& pn7, const float& v7,
...
//_____________________________________________________________________________
bool 
Util::findValueFromTree( TTree* tree, const std::string& searchpar, float& searchval, const std::vector<std::string>& pnVec, const std::vector<float>& vVec, const float& defaultVal )
{
