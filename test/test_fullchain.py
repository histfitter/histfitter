...
bkg_only_test_values = {
    'hbkg1Nom_CR_obs_p': 3.2219999999999756, 
    'hbkg1Nom_SR_obs_m': 5.777999999999959, 
    'hbkg1user_histoSysHigh_CR_obs_p': 3.3830999999999745, 
    'hbkg1user_histoSysHigh_SR_obs_m': 6.066899999999957, 
    'hbkg1user_histoSysLow_CR_obs_p': 3.0608999999999766, 
    'hbkg1user_histoSysLow_SR_obs_m': 5.489099999999961, 
    'hbkg1user_overallSysHigh_CR_obs_p': 3.3830999999999745, 
    'hbkg1user_overallSysHigh_SR_obs_m': 6.066899999999957, 
    'hbkg1user_overallSysLow_CR_obs_p': 3.0608999999999766, 
    'hbkg1user_overallSysLow_SR_obs_m': 5.489099999999961, 
    'hbkg1weight_histoSysEnvelopeSymHigh_CR_obs_p': 3.2846586611647037, 
    'hbkg1weight_histoSysEnvelopeSymHigh_SR_obs_m': 6.070510527144715, 
    'hbkg1weight_histoSysEnvelopeSymLow_CR_obs_p': 3.1593413388352474, 
    'hbkg1weight_histoSysEnvelopeSymLow_SR_obs_m': 5.485489472855202, 
    'hbkg1weight_histoSysHigh_CR_obs_p': 3.3440255509705903, 
    'hbkg1weight_histoSysHigh_SR_obs_m': 6.146948772620593, 
    'hbkg1weight_histoSysLow_CR_obs_p': 3.1044935654749426, 
    'hbkg1weight_histoSysLow_SR_obs_m': 5.43164435395858, 
    'hbkg1weight_histoSysOneSideHigh_CR_obs_p': 3.301659330582352, 
    'hbkg1weight_histoSysOneSideHigh_SR_obs_m': 6.010925263572357, 
    'hbkg1weight_histoSysOneSideLow_CR_obs_p': 3.301659330582352, 
    'hbkg1weight_histoSysOneSideLow_SR_obs_m': 6.010925263572357, 
    'hbkg1weight_histoSysOneSideSymHigh_CR_obs_p': 3.3389524407764695, 
    'hbkg1weight_histoSysOneSideSymHigh_SR_obs_m': 6.107827018096476, 
    'hbkg1weight_histoSysOneSideSymLow_CR_obs_p': 3.1050475592234816, 
    'hbkg1weight_histoSysOneSideSymLow_SR_obs_m': 5.448172981903442, 
    'hbkg1weight_overallHistoSysHigh_CR_obs_p': 3.264366220388233, 
    'hbkg1weight_overallHistoSysHigh_CR_obs_pNorm': 3.221999999999975, 
    'hbkg1weight_overallHistoSysHigh_SR_obs_m': 5.914023509048238, 
    'hbkg1weight_overallHistoSysHigh_SR_obs_mNorm': 5.77799999999996, 
    'hbkg1weight_overallHistoSysLow_CR_obs_p': 3.1801950365209026, 
    'hbkg1weight_overallHistoSysLow_CR_obs_pNorm': 3.221999999999975, 
    ...
    'hbkg2tree_normHistoSysOneSideSymHigh_CR_obs_p': 90.99999999999979, 
    'hbkg2tree_normHistoSysOneSideSymHigh_CR_obs_pNorm': 90.99999999999979, 
    ...
    'hbkg2tree_normHistoSysOneSideSymLow_CR_obs_p': 90.99999999999979, 
    'hbkg2tree_normHistoSysOneSideSymLow_CR_obs_pNorm': 90.99999999999979, 
    ...
    'hbkg2user_normHistoSysHigh_CR_obs_p': 95.54999999999978, 
    'hbkg2user_normHistoSysHigh_CR_obs_pNorm': 90.99999999999979, 
    ...
    'hbkg2user_normHistoSysLow_CR_obs_p': 86.44999999999979, 
    'hbkg2user_normHistoSysLow_CR_obs_pNorm': 90.99999999999977, 
    ...
    'hbkg2weight_normHistoSysEnvelopeSymHigh_CR_obs_p': 92.82000000000059, 
    'hbkg2weight_normHistoSysEnvelopeSymHigh_CR_obs_pNorm': 90.99999999999979, 
    ...
    'hbkg2weight_normHistoSysEnvelopeSymLow_CR_obs_p': 89.17999999999898, 
    'hbkg2weight_normHistoSysEnvelopeSymLow_CR_obs_pNorm': 90.96359999999845, 
    ...
    'hbkg2weight_normHistoSysHigh_CR_obs_p': 92.82000000000059, 
    'hbkg2weight_normHistoSysHigh_CR_obs_pNorm': 90.99999999999979, 
    ...
    'hbkg2weight_normHistoSysLow_CR_obs_p': 89.2156862745101, 
    'hbkg2weight_normHistoSysLow_CR_obs_pNorm': 90.99999999999979, 
    ...
    'hbkg2weight_normHistoSysOneSideHigh_CR_obs_p': 91.91000000000042, 
    'hbkg2weight_normHistoSysOneSideHigh_CR_obs_pNorm': 90.99999999999977, 
    ...
    'hbkg2weight_normHistoSysOneSideLow_CR_obs_p': 91.91000000000042, 
    'hbkg2weight_normHistoSysOneSideLow_CR_obs_pNorm': 90.99999999999977, 
    ...
    'hbkg2weight_overallNormHistoSysEnvelopeSymHigh_CR_obs_p': 93.73000000000009, 
    'hbkg2weight_overallNormHistoSysEnvelopeSymHigh_CR_obs_pNorm': 90.99999999999979, 
    ...
    'hbkg2weight_overallNormHistoSysEnvelopeSymLow_CR_obs_p': 88.26999999999948, 
    'hbkg2weight_overallNormHistoSysEnvelopeSymLow_CR_obs_pNorm': 90.99999999999979, 
    ...
    'hbkg2weight_overallNormSysHigh_CR_obs_p': 93.73000000000009, 
    'hbkg2weight_overallNormSysHigh_CR_obs_pNorm': 90.99999999999979, 
    ...
    'hbkg2weight_overallNormSysLow_CR_obs_p': 88.34951456310662, 
    'hbkg2weight_overallNormSysLow_CR_obs_pNorm': 90.99999999999979, 
    'hbkg2weight_overallNormSysLow_SR_obs_m': 11.650485436893199, 
    'hbkg2weight_overallNormSysLow_SR_obs_mNorm': 12.0, 
    'hdata_CR_obs_p': 105.0, 
    'hdata_SR_obs_m': 21.0
}
