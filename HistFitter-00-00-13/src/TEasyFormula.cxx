...
ClassImp(Combination::TEasyFormula)


//_____________________________________________________________________________
Combination::TEasyFormula::TEasyFormula()
  : TFormula()
{
}
...
//_____________________________________________________________________________
Combination::TEasyFormula::TEasyFormula(const char* expression)
  : TFormula()
{
...
//_____________________________________________________________________________
Combination::TEasyFormula::TEasyFormula(const char* name,const char* expression) 
  : TFormula(name,"1") 
{
  (void) this->SetFormula(expression);
}
...
//_____________________________________________________________________________
Combination::TEasyFormula::TEasyFormula(const Combination::TEasyFormula& other)
  : TFormula(other)
  , m_expr(other.m_expr)
  , m_par(other.m_par)
  , m_stod(other.m_stod)
...
Combination::TEasyFormula::operator=(const Combination::TEasyFormula& other)
{
  if (&other==this) {
    return *this;
  }
...
//_____________________________________________________________________________
Int_t 
Combination::TEasyFormula::SetFormula(const char *expression)
{
  m_par.clear();
  m_stod.clear();
  m_itos.clear();
...
//_____________________________________________________________________________
void
Combination::TEasyFormula::SetValue(const TString& name, const double& value)
{
...
//_____________________________________________________________________________
Double_t
Combination::TEasyFormula::DefinedValue(Int_t code) 
{
...
//_____________________________________________________________________________
Int_t 
Combination::TEasyFormula::DefinedVariable(TString &name, int& action)
{
...
//_____________________________________________________________________________
Int_t 
Combination::TEasyFormula::DefinedVariable(TString &name) 
{
  // Interface to TFormula. If name passed by TFormula is recognized
  // as one of our RooAbsArg servers, return a unique id integer
  // that represent this variable.
...
//_____________________________________________________________________________
void
Combination::TEasyFormula::Summary() const
{
  Combination::TMsgLogger m_logger("TEasyFormula");
...
//_____________________________________________________________________________
Bool_t 
Combination::TEasyFormula::Contains(const TString& parname) const
{
...
//_____________________________________________________________________________
Bool_t
Combination::TEasyFormula::Contains(const std::vector<TString>& parList) const
{
