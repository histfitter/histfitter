...
void makecontourplots(const TString& combo = "all") 
{
  ...
  (void) SUSY_m0_vs_m12_all_withBand_cls("MySimpleChannelAnalysisOutput_fixSigXSecNominal_hypotest__1_harvest_list.root", "", "Tutorial contour", 4.7, showsignal, discexcl=1, showtevatron, showcms, doOneSigmaBand );
}
