...
void makecontourplots(const TString& combo = "all") 
{
  ...
  (void) SUSY_m0_vs_m12_all_withBand_cls("MySimpleChannelAnalysisOutput_hypotest__1_harvest_list.root", "", "SR1a, 20 GeV", 14.3, showsignal, discexcl=1, showtevatron, showcms, doOneSigmaBand );
}
