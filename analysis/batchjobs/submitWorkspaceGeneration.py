...
## from ROOT import *
## file = TFile.Open("root://eosatlas//eos/atlas/atlascerngroupdisk/phys-susy/histfitter/stronglepton/SusyFitterTree_OneSoftMuo_SM_GG_onestepCC_v3.root")
...
logDir       = "%s/submit/logs/workspaceGeneration/%s_%s"       % (SusyFitterDir,mode,configFile.strip(".py"))
