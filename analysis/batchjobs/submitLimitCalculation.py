...
####### CONFIGURATION #######
configFile = 'CombinedKFactorFit_5Channel_JESComponents_p_toys.py'
dryRun =True
...
for point in points:
    cmd = "bsub -q 1nd -R 'hname!=lxbsp20b26 && hname!=lxbsp20b14 && hname!=lxbsq2015 && hname!=lxbsp1543 && hname!=lxbsp2130 && hname!=lxbsp2209 && hname!=lxbsp20b06 && hname!=lxbrf18b01 && hname!=lxbsp2409 && hname!=lxbsp21b34' -e "+logDir+"/out_"+str(point)+".log.e -o "+logDir+"/out_"+str(point)+".log.o runLimitCalculation.sh -p '"+SusyFitterDir+"' -g "+point+" -w "+workspaceDir+" -r "+resultsDir+" -n "+str(nToys)+" -c "+str(calculatorType)+" "+SusyFitterDir+"/test.log"
