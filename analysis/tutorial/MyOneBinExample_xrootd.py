...
configMgr.histCacheFile = "root://eosuser.cern.ch//eos/user/d/damacdon/cern-may2015/HistFitter/"+configMgr.analysisName+".root"
#configMgr.histCacheFile = "root://eosuser.cern.ch//eos/user/d/damacdon/cern-may2015/HistFitter/SusyFitterTree_OneSoftEle_BG_v3.root"
...
if configMgr.readFromTree:
    ...
    bgdFiles.append("root://eosuser.cern.ch//eos/user/d/damacdon/cern-may2015/HistFitter/SusyFitterTree_OneSoftEle_BG_v3.root")
    #bgdFiles.append("samples/tutorial/SusyFitterTree_OneSoftMuo_BG_v3.root")
    bgdFiles.append("root://eosuser.cern.ch//eos/user/d/damacdon/cern-may2015/HistFitter/SusyFitterTree_OneSoftMuo_BG_v3.root") 
else:
...
if myFitType==FitType.Exclusion:
    ...
    sigSample.addInputs(["root://eosuser.cern.ch//eos/user/d/damacdon/cern-may2015/HistFitter/SusyFitterTree_p832_GG-One-Step_soft_v1.root"])
