...
bkgSampleA.addNormFactor("mu_A",1.0,0,100)

bkgSampleB = Sample("dummy_BkgB",kBlue)
bkgSampleB.buildHisto([1],"B","cuts",0.5)
bkgSampleB.addNormFactor("mu_A",1.0,0,100)
bkgSampleB.addNormFactor("eff_B",EffB,0,2.*EffB)

bkgSampleC = Sample("dummy_BkgC",kBlue)
bkgSampleC.buildHisto([1],"C","cuts",0.5)
bkgSampleC.addNormFactor("mu_A",1.0,0,100)
bkgSampleC.addNormFactor("eff_C",EffC,0,2.*EffC) 
...
bkgSampleD.addNormFactor("mu_A",1.0,0,100)
bkgSampleD.addNormFactor("eff_B",EffB,0,2.*EffB)
bkgSampleD.addNormFactor("eff_C",EffC,0,2.*EffC)
