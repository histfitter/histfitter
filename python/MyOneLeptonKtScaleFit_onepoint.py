...
#---------------------------------------
rel17=True # Do we still need this?
useStat=True
doHardLep=True
doSoftLep=False
doValidation=False
...
if configMgr.readFromTree:
    if rel17:
        ...
        #h1l
        if doHardLep:
            configMgr.inputFileNames.append("/afs/cern.ch/atlas/groups/susy/1lepton/samples/paper/SusyFitterTree_OneEle.root")
            configMgr.inputFileNames.append("/afs/cern.ch/atlas/groups/susy/1lepton/samples/paper/SusyFitterTree_OneMu.root")
        #s1l
        if doSoftLep:
            configMgr.inputFileNames.append("/afs/cern.ch/atlas/groups/susy/1lepton/samples/SusyFitterTree_OneSoftEle_BG_v3.root")
            configMgr.inputFileNames.append("/afs/cern.ch/atlas/groups/susy/1lepton/samples/SusyFitterTree_OneSoftMuo_BG_v3.root")
        if doHardLep:
            # mSUGRA
            configMgr.inputFileNames.append("/afs/cern.ch/atlas/groups/susy/1lepton/samples/SusyFitterTree_p832_mSUGRA_v5.root")
            # 1-step simplified model
            configMgr.inputFileNames.append("/afs/cern.ch/atlas/groups/susy/1lepton/samples/SusyFitterTree_p832_GG-One-Step_v2.root")
            
        if doSoftLep:
            # 1-step simplified model
            configMgr.inputFileNames.append("/afs/cern.ch/atlas/groups/susy/1lepton/samples/SusyFitterTree_p832_GG-One-Step_soft_v1.root")
    else:
        configMgr.inputFileNames = ["/afs/cern.ch/atlas/groups/susy/1lepton/samples/SusyFitterTree_OneEle.root","/afs/cern.ch/atlas/groups/susy/1lepton/samples/SusyFitterTree_OneMu.root"]
else:
...
if doExclusion:
    ...
    #if rel17:
    #    if doHardLep:
    #        sigSamples=["SM_GG_onestepCC_225_185_145","SM_GG_onestepCC_317_304_292","SM_GG_onestepCC_705_385_65","SM_GG_onestepCC_305_185_65","SM_GG_onestepCC_505_305_105"]
    #        [sigSamples.append(s) for s in ["SU_180_240_0_10_P","SU_180_600_0_10_P","SU_2020_300_0_10_P","SU_2020_480_0_10_P","SU_3380_330_0_10_P","SU_1060_300_0_10_P"]]
    #    if doSoftLep:
    #        sigSamples=["SM_GG_onestepCC_225_185_145","SM_GG_onestepCC_317_304_292","SM_GG_onestepCC_705_385_65","SM_GG_onestepCC_305_185_65","SM_GG_onestepCC_505_305_105"]
