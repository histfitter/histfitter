...
jesWR = Systematic("JW","_NoSys","_JESup","_JESdown","tree","overallHistoSys")
jesTR = Systematic("JT","_NoSys","_JESup","_JESdown","tree","overallHistoSys")
jesS3 = Systematic("J3","_NoSys","_JESup","_JESdown","tree","overallHistoSys")
jesS4 = Systematic("J4","_NoSys","_JESup","_JESdown","tree","overallHistoSys")
...
meas=NpX.addMeasurement(name="NormalMeasurement",lumi=1.0,lumiErr=0.039)
meas.addPOI("mu_SIG")
#CRs
