...
configMgr.analysisName = "MySoftOneLeptonKtScaleFitMetMeff"
...
## metMeffSLVR1 = bkt.addChannel("met/meff2Jet",["SLVR1"],5,0.0,1.0)
## bkt.setValidationChannels([nJetSLVR1,nBJetSLVR1,meffSLVR1,metSLVR1,metMeffSLVR1]) #These are not necessarily statistically independent
...
## metMeffSLVR2 = bkt.addChannel("met/meff2Jet",["SLVR2"],5,0.0,1.0)
## bkt.setValidationChannels([nJetSLVR2,nBJetSLVR2,meffSLVR2,metSLVR2,metMeffSLVR2]) #These are not necessarily statistically independent
...
"""
#SRs
metmeffSS = bkt.addChannel("met/meff2Jet",["SS"],5,0.0,1.0)
metmeffSS.addSystematic(jesSLSR)
metmeffSS.useOverflowBin=True
bkt.setBkgConstrainChannels([nJetSLW,nJetSLT,metmeffSS])
...
SSChannel.addDiscoverySamples(["SS"],[1.],[-10.],[10.],[kMagenta])
...
for sig in sigSamples:
    ...
    metOverMeff = myTopLvl.addChannel("met/meff2Jet",["SS"],6,0.1,0.7) # change binning
