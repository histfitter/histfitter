...
from ROOT import THStack, TLegend, TCanvas, TFile, std, TH1F, TH2F, gStyle, TList
...
##                     pass
    ...
    def addSampleSpecificHists(self, fitConfig, chan, sam, regionString, normRegions, normString, normCuts):
        ...
        if sam.isData:
            ...
            if not self.ignoreSystematics:
                ...
                syst_types = ["weight", "tree", "hist", "user"]
                systs_by_type = {}
                ...
                log.info("      - Will load {} weights, {} tree-based, {} hist-based and {} user systematics".format(len(systs_by_type["weight"]), len(systs_by_type["tree"]), len(systs_by_type["hist"]), len(systs_by_type["user"])))
    ...
    def buildBlindedHistos(self, fitConfig, channel, sample):
        ...
        self.hists[histname].Merge(blindhistlist)
        return
