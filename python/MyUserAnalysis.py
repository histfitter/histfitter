...
ndata     =  100. 	# Number of events observed in data
nbkg      =  100.	# Number of predicted bkg events
nsig      =  1.  	# Number of predicted signal events
nbkgErr   =  10.  	# (Absolute) Statistical error on bkg estimate
nsigErr   =  0.  	# (Absolute) Statistical error on signal estimate
...
sigSample.setNormFactor("mu_Sig",1.,0.,70.)
