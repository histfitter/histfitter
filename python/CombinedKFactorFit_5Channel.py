...
nJetTopeChannel.addSystematic(jesTR)
...
nJetTopemChannel.addSystematic(jesTR)
...
nJetTopmmChannel.addSystematic(jesTR)
...
nJetTopmChannel.addSystematic(jesTR)
...
nJetZeChannel.addSystematic(jesZR)
...
nJetZmmChannel.addSystematic(jesZR)
...
nJetZmChannel.addSystematic(jesZR)
...
# HARD LEPTON SRS
    ...
    meffS3T_El.addSystematic(jesS3T)
    ...
    meffS3T_Mu.addSystematic(jesS3T)
    ...
    meffS4T_El.addSystematic(jesS4T)
    ...
    meffS4T_Mu.addSystematic(jesS4T)
