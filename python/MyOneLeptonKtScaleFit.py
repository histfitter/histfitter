...
if configMgr.readFromTree:
    ...
    configMgr.inputFileNames = ["samples/"+configMgr.analysisName+".root"]
...
topPtMin30S3 = Systematic("PtMinTop3",configMgr.weights,1.,0.88,"user","userOverallSys")
wzPtMin30S3 = Systematic("PtMinWZ3",configMgr.weights,1.,0.81,"user","userOverallSys")
topPtMin30S4 = Systematic("PtMinTop4",configMgr.weights,1.,0.84,"user","userOverallSys")
wzPtMin30S4 = Systematic("PtMinWZ4",configMgr.weights,1.,0.92,"user","userOverallSys")
